import{q as f,r as w,G as z,N as H,Y as a,x as u,z as W,K as V,v as b,y as L,X as N,I as D,Z as G}from"./chunk-BAXFHI7N-COAZJZTd.js";import{n as d,r as c,c as m,U as v,o as q}from"./if-defined-B6ML-vd_.js";import{e as U,n as O}from"./index-D5xoZOQz.js";import"./index-Da__D__N.js";import"./index-D6WgYpbH.js";import{S as F}from"./index-DI7BUoCr.js";import"./index-F6-SoxJD.js";import"./index-JrAcb4hS.js";import"./index-DCAxcOhS.js";import"./index-B-9tx4pG.js";import"./index-BoU1SRFc.js";const M=f`
  :host {
    width: 100%;
    height: 100px;
...
`;var I=function(o,e,i,n){var r=arguments.length,t=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(o,e,i,n);else for(var l=o.length-1;l>=0;l--)(s=o[l])&&(t=(r<3?s(t):r>3?s(e,i,t):s(e,i))||t);return r>3&&t&&Object.defineProperty(e,i,t),t};let y=class extends w{constructor(){super(),this.unsubscribe=[],this.tokenBalances=a.state.tokenBalances,this.search="",this.onDebouncedSearch=z.debounce(e=>{this.search=e}),this.unsubscribe.push(a.subscribe(e=>{this.tokenBalances=e.tokenBalances}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return u`
    ...
    `}onBuyClick(){b.push("OnRampProviders")}onInputChange(e){this.onDebouncedSearch(e.detail)}handleTokenClick(e){a.setToken(e),a.setTokenAmount(void 0),b.goBack()}};y.styles=Q;I([c()],y.prototype,"tokenBalances",void 0);I([c()],y.prototype,"tokens",void 0);I([c()],y.prototype,"filteredTokens",void 0);I([c()],y.prototype,"search",void 0);y=I([m("w3m-wallet-send-select-token-view")],y);const ee=f`
  :host {
    display: flex;
