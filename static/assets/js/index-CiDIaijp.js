import{$ as _,a2 as O,a3 as R,q as d,z as y,r as h,x as l,O as c,K as j}from"./chunk-BAXFHI7N-COAZJZTd.js";import{n as v,c as p,o as P,r as T}from"./if-defined-B6ML-vd_.js";import{e as U,n as L}from"./index-D5xoZOQz.js";const u=_({isLegalCheckboxChecked:!1}),g={state:u,subscribe(i){return R(u,()=>i(u))},subscribeKey(i,e){return O(u,i,e)},setIsLegalCheckboxChecked(i){u.isLegalCheckboxChecked=i}},E=d`
  label {
    display: flex;
    align-items: center;
    cursor: pointer;
...
`;var B=function(i,e,r,n){var o=arguments.length,t=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,r):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(i,e,r,n);else for(var a=i.length-1;a>=0;a--)(s=i[a])&&(t=(o<3?s(t):o>3?s(e,r,t):s(e,r))||t);return o>3&&t&&Object.defineProperty(e,r,t),t};let x=class extends h{render(){return l`
    ...
    `}};x.styles=[y,j,z];x=B([p("wui-ux-by-reown")],x);const D=d`
  :host > wui-flex {
